...
This skill adds Telegram support to NanoPieLot, then walks through interactive setup.
...
```bash
git remote add telegram https://github.com/trsdn/nanopielot-telegram.git
```
...
- Check bot is started: `tail -f logs/nanopielot.log`
