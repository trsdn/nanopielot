---
name: add-pdf-reader
description: Add PDF reading to NanoPieLot agents. Extracts text from PDFs via pdftotext CLI. Handles WhatsApp attachments, URLs, and local files.
---
...
```bash
tail -f logs/nanopielot.log | grep -i pdf
```
