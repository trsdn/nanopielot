...
This skill adds Slack support to NanoPieLot, then walks through interactive setup.
...
>
> The JID format for NanoPieLot is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.nanopielot`
