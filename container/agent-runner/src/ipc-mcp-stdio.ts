/**
 * Stdio MCP Server for NanoPieLot
...
const chatJid = process.env.NANOPIELOT_CHAT_JID!;
const groupFolder = process.env.NANOPIELOT_GROUP_FOLDER!;
const isMain = process.env.NANOPIELOT_IS_MAIN === '1';
