...
Fork it, make changes on a branch, open a PR. See `CONTRIBUTING.md`.

## Credits

Port of NanoClaw by trsdn. The original project's philosophy, architecture, and skill system are preserved. The Claw just got a Pilot now. 🥧
